...
import desico.project.service.impl.ProjectDBUserService;
...
public class AplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    private final ProjectDBUserService projectDBUserService;
    private final PasswordEncoder passwordEncoder;

    public AplicationSecurityConfig(ProjectDBUserService projectDBUserService, PasswordEncoder passwordEncoder) {
        this.projectDBUserService = projectDBUserService;
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.
                userDetailsService(projectDBUserService).
